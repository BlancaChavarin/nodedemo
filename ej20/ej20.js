...
//especificamos el subdirectorio donde se encuentra n las pagina estaticas
app.use(express.static(__dirname + '/public'));

//extended: false significa que parsea solo string (no archivos de imagenes)
...
app.get('/mostrartabla', (req,res) => {
    ...
    num=parseInt(num);
    let pagina='<!doctype html><head></head><body>'
    for(let x=1;x<=10;x++){
        let tabla=num * x;
